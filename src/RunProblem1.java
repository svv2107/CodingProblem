...
public class RunProblem1 {
	...
	public static void main(String[] args) {
		...
		int[] anArray = {1,2};
		System.out.println(Arrays.toString(consecutive3(anArray)));
		
		int[] anArray2 = {1,2,3,5,10,9,8,9,10,11,7};
		System.out.println(Arrays.toString(consecutive3(anArray2)));
		
		int[] anArray3 = {};
		System.out.println(Arrays.toString(consecutive3(anArray3)));
	}
	
	public static int[] consecutive3(int[] inArray){
